...
func (ivf *IVFIndex) Save(w io.Writer) error {
	...
	// Encode parameters
	if err := enc.Encode(ivf.NCentroids); err != nil {
		return err
	}
	if err := enc.Encode(ivf.Dimension); err != nil {
		return err
	}
	if err := enc.Encode(ivf.NProbe); err != nil {
		return err
	}
	if err := enc.Encode(ivf.Trained); err != nil {
		return err
	}

	// Encode data
	if err := enc.Encode(ivf.Centroids); err != nil {
		return err
	}
	if err := enc.Encode(ivf.Invlists); err != nil {
		return err
	}
	if err := enc.Encode(ivf.IDs); err != nil {
		return err
	}

	// Note: We encode vectors too to enable fast startup without SQL scan
	if err := enc.Encode(ivf.Vectors); err != nil {
		return err
	}
...
func (ivf *IVFIndex) Load(r io.Reader) error {
	...
	// Decode parameters
	if err := dec.Decode(&ivf.NCentroids); err != nil {
		return err
	}
	if err := dec.Decode(&ivf.Dimension); err != nil {
		return err
	}
	if err := dec.Decode(&ivf.NProbe); err != nil {
		return err
	}
	if err := dec.Decode(&ivf.Trained); err != nil {
		return err
	}

	// Decode data
	if err := dec.Decode(&ivf.Centroids); err != nil {
		return err
	}
	if err := dec.Decode(&ivf.Invlists); err != nil {
		return err
	}
	if err := dec.Decode(&ivf.IDs); err != nil {
		return err
	}
	if err := dec.Decode(&ivf.Vectors); err != nil {
		return err
	}
